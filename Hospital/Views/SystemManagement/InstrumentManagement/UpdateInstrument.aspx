<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateInstrument.aspx.cs" Inherits="Hospital.Views.SystemManagement.InstrumentManagement.UpdateInstrument" %>
                                ...
                                <form runat="server">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" id="I_ID" runat="server" disabled="disabled">
                                        </div>
                                       </div>
                                        <div class="form-group">
                                            <label>名称</label>
