<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="Hospital.Views.SystemManagement.Department.Department" %>
              ...
              <div class="card">
                <div class="card-body">
                 <form runat="server">
                  ...
                  <asp:SqlDataSource ID="DepartmentDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:hospitalConnectionString3 %>" ProviderName="<%$ ConnectionStrings:hospitalConnectionString3.ProviderName %>" SelectCommand="SELECT DE_Name FROM department" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>                      
                  </form>
                 </div>                 
                </div>
              </div>
