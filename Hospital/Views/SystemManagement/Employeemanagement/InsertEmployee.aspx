<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertEmployee.aspx.cs" Inherits="Hospital.Views.SystemManagement.Employeemanagement.InsertEmployee" %>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">增添医护信息</h4>
                                <form runat="server">
                                    <div class="form-group">
                                        <label>员工ID</label>
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" id="E_ID" runat="server" />
                                        </div>
                                       </div>
                                        <div class="form-group">
                                            <label>姓名</label>
