<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateEmployee.aspx.cs" Inherits="Hospital.Views.SystemManagement.Employeemanagement.UpdateEmployee" %>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">更新信息</h4>
                                <form runat="server">
                                    <div class="form-group">
                                        <label>员工ID</label>
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" id="E_ID" runat="server" disabled="disabled"/>
                                        </div>
                                       </div>
                                        <div class="form-group">
                                            <label>姓名</label>
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" id="E_Name" runat="server" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>性别</label>
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" id="E_Sex" runat="server" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>年龄</label>
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" id="E_Age" runat="server" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>部门ID</label>
                                        ...
                                        <div style="text-align: center" runat="server">
                                            <asp:Button ID="update" runat="server" Text="更新" class="btn btn-gradient-primary mr-2" OnClick="update_Click"/>
                                            <asp:Button ID="delete" runat="server" Text="删除" class="btn btn-gradient-primary mr-2" OnClick="delete_Click"/>
                                        </div>
                                </form>
                            </div>
                            <!-- main-panel ends -->
