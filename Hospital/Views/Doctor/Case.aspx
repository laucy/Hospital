                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        ...
                        <span class="input-group-append">
                          <button class="file-upload-browse btn btn-gradient-primary" type="button">查询</button>
                        </span>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">病人姓名</label>
                      <input type="email" class="form-control" id="exampleInputEmail3" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">病人性别</label>
